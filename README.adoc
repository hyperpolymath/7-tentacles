...
:experimental:
:url-github: https://github.com/hyperpolymath/7-tentacles
:url-gitlab: https://gitlab.com/hyperpolymath/7-tentacles
:url-bitbucket: https://bitbucket.org/hyperpolymath/7-tentacles
:url-codeberg: https://codeberg.org/hyperpolymath/7-tentacles
...
7-tentacles is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
